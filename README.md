Сервис рассылки "Healthy_habits_tracker" Сервис реализован на основе фреймворка Django REST framework (DRF). Для работы с проектом вам так же потребуется установленная БД PostgreSQL.
