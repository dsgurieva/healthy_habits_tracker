...
from habits.views import HabitsCreateAPIView, HabitsListAPIView, \
...
urlpatterns = [
    ...
    path('<int:pk>/', HabitsRetrieveAPIView.as_view(),
         name='habits_get'),
    path('update/<int:pk>/', HabitsUpdateAPIView.as_view(),
         name='habits_update'),
    path('delete/<int:pk>/', HabitsDestroyAPIView.as_view(),
         name='habits_delete'),
]
